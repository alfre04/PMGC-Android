...
(function(e, t, n, r) {
    ...
    }(), f = n.createElement("div").style.backgroundPositionX !== r, l = function() {
    ...
    d.prototype = {
        ...
        _findBackgrounds: function() {
            ...
            s = this.$element.find("[data-stellar-background-ratio]"), this.$element.is("[data-stellar-background-ratio]") && s.add(this.$element), s.each(function() {
                var s = e(this), o = c(s), u, a, f, h, p, d, v, m, g, y = 0, b = 0, w = 0, E = 0;
        ...
        destroy: function() {
            ...
            for (s = this.particles.length-1; s >= 0; s--)
                t = this.particles[s], n = t.$element.data("stellar-startingLeft"), r = t.$element.data("stellar-startingTop"), this._setLeft(t.$element, n, n), this._setTop(t.$element, r, r), this.options.showElement(t.$element), t.$element.data("stellar-startingLeft", null).data("stellar-elementIsActive", null).data("stellar-backgroundIsActive", null);
            for (s = this.backgrounds.length-1; s >= 0; s--)
                i = this.backgrounds[s], l(i.$element, i.startingValueLeft, i.startingValueTop);
        ...
        _repositionElements: function() {
            var e = this._getScrollLeft(), t = this._getScrollTop(), n, r, i, s, o, u, a, f=!0, c=!0, h, p, d, v, m;
        ...
        _startViewportDetectionLoop: function() {
            var e = this, t = function() {
                var t = e.$viewportElement.offset(), n = t !== null && t !== r;
